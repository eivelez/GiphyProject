...
import com.abstractchile.clase10.SubcategoryFragment.OnListFragmentInteractionListener2
 ...
 */
class MySubcategoryRecyclerViewAdapter(
    private val mValues: List<String>,
    private val mListener: OnListFragmentInteractionListener2?
) : RecyclerView.Adapter<MySubcategoryRecyclerViewAdapter.ViewHolder>() {
