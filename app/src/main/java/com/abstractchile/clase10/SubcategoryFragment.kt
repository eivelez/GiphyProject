...
class SubcategoryFragment : Fragment() {
    ...
    var listOfSubcategories:MutableList<String> = ArrayList()
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MySubcategoryRecyclerViewAdapter(listOfSubcategories, listener)
            }
        }
        return view
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(input: MutableList<String>) =
            SubcategoryFragment().apply {
                listOfSubcategories=input
